            ...
            {session ? (
                <Menu as="div" className="menu relative">
                    ...
                    <Transition
                        ...
                        <Menu.Items className="menu-items bg-white dark:text-react absolute right-0 mt-1 flex w-96 origin-top-right 
                            flex-col rounded-xl py-6 text-white shadow-lg focus:outline-none dark:bg-white">
                ...
                <button className="rounded-md border border-stone-300 
                    px-3 py-1 text-sm dark:border-stone-600"
                    onClick={() => signIn()}>
                    Sign In
                </button>
            )}
